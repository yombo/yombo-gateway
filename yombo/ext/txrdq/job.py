...
class Job(object):
    ...
    def __init__(self, jobarg, priority, done_callback, done_arg):
        self.jobarg = jobarg
    ...
    def launch(self, func):
        ...
        if self.state != self.PENDING:
            ...
            if self.done_callback is not None:
                if self.done_arg is None:
                    self._underwayDeferred.addCallback(self.done_callback)
                else:
                    self._underwayDeferred.addCallback(self.done_callback, self.done_arg)
            ...
            self._underwayDeferred.addErrback(logger.warn)
