...
class DeprecatedWarning(DeprecationWarning):
    ...
    def __init__(self, function, called_by, deprecated_in, removed_in, details=""):
    ...
    *Usage**:
    ...
    .. code-block:: python
        ...
        @deprecated(deprecated_in="0.21.0", removed_in="0.22.0",
                    ...
                    details="Use the 'some_new_method()' instead.")
    ...
    def _function_wrapper(function):
        ...
        def _inner(*args, **kwargs):
            ...
            if should_warn:
                ...
                the_warning = cls("%s::%s()" % (frm_module, function.__name__), called_by, deprecated_in,
                                  removed_in, details)
                warnings.warn(the_warning, category=DeprecationWarning,
                              stacklevel=2)
                logger.warn("{the_warning}", the_warning=the_warning)
