...
<script>
  ...
  import Footer from '@/layouts/GlobalItems/Footer.vue';
  ...
  export default {
    ...
    computed: {
      nav_items: function () {
        return this.$store.state.gateway.globalitems_navbar_items.data;
      },
      last_download_at: function () {
        return this.$store.state.gateway.globalitems_navbar_items.last_download_at;
      },
    },
    methods: {
      toggleSidebar() {
    ...
    mounted() {
      this.$store.dispatch('gateway/globalitems_navbar_items/refresh');
