...
def route_devtools_config_device_types(webapp):
    with webapp.subroute("/devtools") as webapp:
        ...
        def page_devtools_device_types_details_get(webinterface, request, session, device_type_id):
            ...
            try:
                category_results = yield webinterface._YomboAPI.request(
                    "GET",
                    f"/v1/category/{device_type_results['data']['category_id']}",
                    session=session["yomboapi_session"])
            except YomboWarning as e:
                webinterface.add_alert(e.html_message, "warning")
                return webinterface.redirect(request, "/devtools/config/device_types/index")
            ...
            try:
                device_type_commands_results = yield webinterface._YomboAPI.request(
                    "GET", f"/v1/device_type_command/?_filters[device_type_id]={device_type_id}",
                    session=session["yomboapi_session"])
            except YomboWarning as e:
                webinterface.add_alert(e.html_message, "warning")
                return webinterface.redirect(request, "/devtools/config/device_types/index")
        ...
        def page_devtools_device_types_delete_get(webinterface, request, session, device_type_id):
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/details",
                                        device_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/delete", "Delete")
            return page.render(alerts=webinterface.get_alerts(),
                                    device_type=device_type_results["data"],
                                    )
        ...
        def page_devtools_device_types_delete_post(webinterface, request, session, device_type_id):
            ...
            msg = {
                ...
                "description": "<p>The device type has been deleted.</p>"
                               ...
                               '<li><stron>'
                               '<a href="/devtools/config/device_types/{device_type_id}/details">View the device type</a>'
                               "</strong></li></ul></p>",
            }

            try:
                device_type_results = yield webinterface._YomboAPI.request("GET",
                                                                           f"/v1/device_types/{device_type_id}")
            except YomboWarning as e:
                webinterface.add_alert(e.html_message, "warning")
                return webinterface.redirect(request, "/devtools/config/device_types/index")
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/details",
                                        device_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/delete",
                                        "Delete")
        ...
        def page_devtools_device_types_disable_get(webinterface, request, session, device_type_id):
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/details",
                                        device_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/disable", "Disable")
        ...
        def page_devtools_device_types_disable_post(webinterface, request, session, device_type_id):
            ...
            if confirm != "disable":
                webinterface.add_alert("Must enter 'disable' in the confirmation box to disable the device type.",
                                       "warning")
                return webinterface.redirect(request,
                                             f"/devtools/config/device_types/{device_type_id}/device_type_id")
            ...
            msg = {
                ...
                "description":
                    '<p>The device type has been disabled.</p>'
                    '<p>Continue to <a href="/devtools/config/device_types/index">device types index</a> or '
                    f'<a href="/devtools/config/device_types/{device_type_id}/details">view the device type</a>.</p>',
            }
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/details",
                                        device_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/disable",
                                        "Disable")
        ...
        def page_devtools_device_types_enable_post(webinterface, request, session, device_type_id):
            ...
            msg = {
                ...
                "description": f'<p>The device type has been enabled.</p><p>Continue to '
                               f'<a href="/devtools/config/device_types/index">device types index</a> or '
                               f'<a href="/devtools/config/device_types/{device_type_id}/details">view the device type</a>.</p>',
            }
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/details",
                                        device_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/enable",
                                        "Enable")
            return page.render(alerts=webinterface.get_alerts(),
                                    msg=msg,
                                    )
        ...
        def page_devtools_device_types_add_post(webinterface, request, session):
            ...
            msg = {
                ...
                "description": "<p>The device type has been added. If you have requested this device type to be made "
                               "public, please allow a few days for Yombo review.</p><p>Continue to "
                               '<a href="/devtools/config/device_types/index">device types index</a> or '
                               f'<a href="/devtools/config/device_types/{device_type_results["data"]["id"]}/details">view the new device type</a>.</p>',
            }
        ...
        def page_devtools_device_types_edit_get(webinterface, request, session, device_type_id):
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/details",
                                        device_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/device_types/{device_type_id}/edit", "Edit")
            ...
            return page_devtools_devicestypes_form(
                ...
                category_results["data"],
                f"Edit Device Type: {device_type_results['data']['label']}")
        ...
        def page_devtools_device_types_edit_post(webinterface, request, session, device_type_id):
            ...
            msg = {
                ...
                "description":
                    "<p>The device type has been updated. If you have requested this device type to be made public, "
        ...
        def page_devtools_device_types_variables_get(webinterface, request, session, device_type_id):
            ...
            root_breadcrumb(webinterface, request)
            webinterface.add_breadcrumb(request, "/devtools/config/device_types/{device_type_id}/details",
                                        device_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, "/devtools/config/device_types/{device_type_id}/variables",
                                        "Variable Groups")
            return page.render(alerts=webinterface.get_alerts(),
                               device_type=device_type_results["data"],
                               )
