...
def route_devtools_config_input_types(webapp):
    with webapp.subroute("/devtools") as webapp:
        ...
        def page_devtools_input_types_details_get(webinterface, request, session, input_type_id):
            ...
            try:
                category_results = yield webinterface._YomboAPI.request("GET",
                                                                        f"/v1/category/{input_type_results['data']['category_id']}",
                                                                        session=session["yomboapi_session"])
            except YomboWarning as e:
                webinterface.add_alert(e.html_message, "warning")
                return webinterface.redirect(request, "/devtools/config/input_types/index")
            ...
            root_breadcrumb(webinterface, request)
            webinterface.add_breadcrumb(request, "/devtools/config/input_types/index", "Input Types")
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/details",
        ...
        def page_devtools_input_types_delete_get(webinterface, request, session, input_type_id):
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/details",
                                        input_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/delete", "Delete")
            return page.render(alerts=webinterface.get_alerts(),
                                    input_type=input_type_results["data"],
                                    )
        ...
        def page_devtools_input_types_delete_post(webinterface, request, session, input_type_id):
            try:
                ...
                return webinterface.redirect(request, f"/devtools/config/input_types/{input_type_id}/details")
            ...
            msg = {
                ...
                "description":
                    "<p>The input type has been deleted.</p>"
                    '<p>Continue to <a href="/devtools/config/input_types/index">input type index</a> or '
                    f'<a href="/devtools/config/input_types/{input_type_id}/details">view the input type</a>.</p>',
            }

            try:
                input_type_results = yield webinterface._YomboAPI.request("GET",
                                                                          f"/v1/input_types/{input_type_id}",
                                                                          session=session["yomboapi_session"])
            except YomboWarning as e:
                webinterface.add_alert(e.html_message, "warning")
                return webinterface.redirect(request, "/devtools/config/input_types/index")
        ...
        def page_devtools_input_types_disable_get(webinterface, request, session, input_type_id):
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/details",
                                        input_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/disable", "Disable")
        ...
        def page_devtools_input_types_disable_post(webinterface, request, session, input_type_id):
            ...
            if confirm != "disable":
                webinterface.add_alert("Must enter 'disable' in the confirmation box to disable the input type.",
                                       "warning")
                return webinterface.redirect(request, f"/devtools/config/input_types/{input_type_id}/input_type_id")
            ...
            msg = {
                ...
                "description":
                    "<p>The input type has been disabled.</p><p>Continue to "
                    '<a href="/devtools/config/input_types/index">input types index</a> or '
                    f'<a href="/devtools/config/input_types/{input_type_id}/details">view the input type</a>.</p>',
            }
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/details",
                                        input_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/disable",
                                        "Disable")
        ...
        def page_devtools_input_types_enable_post(webinterface, request, session, input_type_id):
            ...
            msg = {
                ...
                "description":
                    "<p>The input type has been enabled.</p><p>Continue to "
                    '<a href="/devtools/config/input_types/index">input types index</a> or '
                    f'<a href="/devtools/config/input_types/{input_type_id}/details">view the input type</a>.</p>',
            }
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/details",
                                        input_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/enable", "Enable")
        ...
        def page_devtools_input_types_add_post(webinterface, request, session):
            ...
            msg = {
                ...
                "description":
                    "<p>The input type has been added. If you have requested this input type to be made public, please "
                    'allow a few days for Yombo review.</p><p>Continue to'
                    ' <a href="/devtools/config/input_types/index">input types index</a> or '
                    f'<a href="/devtools/config/input_types/{input_type_results["input_type_id"]}/details">view the new input type</a>.</p>',
            }
        ...
        def page_devtools_input_types_edit_get(webinterface, request, session, input_type_id):
            ...
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/details",
                                        input_type_results["data"]["label"])
            webinterface.add_breadcrumb(request, f"/devtools/config/input_types/{input_type_id}/edit", "Edit")

            return page_devtools_input_types_form(webinterface, request, session, "edit", input_type_results["data"],
                                               category_results["data"],
                                               f"Edit Input Type: {input_type_results['data']['label']}")
        ...
        def page_devtools_input_types_edit_post(webinterface, request, session, input_type_id):
            ...
            msg = {
                ...
                "description": "<p>The input type has been updated. If you have requested this input type to be made "
                               "public, please allow a few days for Yombo review.</p>"
                               '<p>Continue to <a href="/devtools/config/input_types/index">input types index</a> or '
                               f'<a href="/devtools/config/input_types/{input_type_id}/details">view the updated input type</a>.</p>',
            }
