...
def route_automation_template(webapp):
    with webapp.subroute("/automation") as webapp:
        ...
        def page_automation_condition_template_get(webinterface, request, session, rule_id):
            ...
            webinterface.add_breadcrumb(request, f"/automation/{rule_id}/add_condition_template", "Add action: Template")
        ...
        def page_automation_condition_template_post(webinterface, request, session, rule_id):
            ...
            try:
                ...
                webinterface.add_alert(f"Cannot set rule condition template: {e.message}", "warning")
        ...
        def page_automation_action_template_edit_get(webinterface, request, session, rule_id, action_id):
            ...
            root_breadcrumb(webinterface, request)
            webinterface.add_breadcrumb(request, f"/automation/{rule_id}/details", rule.label)
            webinterface.add_breadcrumb(request, f"/automation/{rule_id}/edit_template", "Edit action: Template")
        ...
        def page_automation_action_template_edit_post(webinterface, request, session, rule_id, action_id):
            ...
            try:
                ...
                webinterface.add_alert(f"Cannot edit template within automation rule. {e.message}", "warning")
            ...
            webinterface.add_alert(f"Edited a template action for automation rule '{rule.label}'.")
            return webinterface.redirect(request, f"/automation/{rule_id}/details")
        ...
        def page_automation_action_template_add_get(webinterface, request, session, rule_id):
            ...
            root_breadcrumb(webinterface, request)
            webinterface.add_breadcrumb(request, f"/automation/{rule_id}/details", rule.label)
            webinterface.add_breadcrumb(request, f"/automation/{rule_id}/add_action_template", "Add action: Template")
            return page_automation_action_form_template(webinterface, request, session, rule, data, "add", "Add a template to automation rule")
        ...
        def page_automation_action_template_add_post(webinterface, request, session, rule_id):
            ...
            try:
                ...
                webinterface.add_alert(f"Cannot add template to automation rule. {e.message}", "warning")
                return page_automation_action_form_template(webinterface, request, session, rule, data, "add", "Add a template to automation rule")
        ...
        def page_automation_action_template_edit_get(webinterface, request, session, rule_id, action_id):
            ...
            if action["action_type"] != "template":
                webinterface.add_alert("Requested action type is invalid.", "warning")
                return webinterface.redirect(request, "/automation/{rule_id}/details")
        ...
        def page_automation_action_template_delete_get(webinterface, request, session, rule_id, action_id):
            ...
            root_breadcrumb(webinterface, request)
            webinterface.add_breadcrumb(request, f"/automation/{rule_id}/details", rule.label)
            webinterface.add_breadcrumb(request, f"/automation/{rule_id}/delete_action_template", "Delete action: Template")
            return page.render(alerts=webinterface.get_alerts(),
                               rule=rule,
                               action=action,
                               action_id=action_id,
        ...
        def page_automation_action_template_delete_post(webinterface, request, session, rule_id, action_id):
            ...
            try:
                ...
                return webinterface.redirect(request,
                                             f"/automation/{rule_id}/delete_action_template/{action_id}")
            ...
            try:
                ...
                webinterface.add_alert("Cannot delete template from automation rule. {e.message}", "warning")
                return webinterface.redirect(request, "/automation/index")
