...
def route_roles(webapp):
    with webapp.subroute("/roles") as webapp:
        ...
        def page_roles_details_get(webinterface, request, session, role_id):
            ...
            root_breadcrumb(webinterface, request)
            webinterface.add_breadcrumb(request, f"/roles/{role_id}/details", role.label)
            return page.render(
                alerts=webinterface.get_alerts(),
                request=request,
                role=role,
        ...
        def page_roles_add_post(webinterface, request, session):
            ...
            try:
                ...
                webinterface.add_alert(f"Cannot add role. {e.message}", "warning")
                return page_roles_form(webinterface, request, session, "add", data, "Add Role",)

            webinterface.add_alert(f"New role '{data['label']}' added.")
            return webinterface.redirect(request, f"/roles/{role.role_id}/details")
        ...
        def page_roles_edit_get(webinterface, request, session, role_id):
            ...
            root_breadcrumb(webinterface, request)
            webinterface.add_breadcrumb(request, f"/roles/{role.role_id}/details", role.label)
            webinterface.add_breadcrumb(request, f"/roles/{role.role_id}/edit", "Edit")
            data = {
                "label": role.label,
        ...
        def page_roles_edit_post(webinterface, request, session, role_id):
            ...
            try:
                ...
                webinterface.add_alert(f"Cannot edit role. {e.message}", "warning")
                root_breadcrumb(webinterface, request)
                webinterface.add_breadcrumb(request, f"/roles/{role.role_id}/details", role.label)
                webinterface.add_breadcrumb(request, f"/roles/{{role.role_id}}/edit", "Edit")
            ...
            webinterface.add_alert(f"Role '{role.label}' edited.")
            return webinterface.redirect(request, f"/roles/{role.role_id}/details")
        ...
        def page_roles_add_item_permission_post(webinterface, request, session, role_id):
            ...
            return webinterface.redirect(request, f"/roles/{role_id}/details")
        ...
        def page_roles_remove_item_permission_get(webinterface, request, session, role_id, platform, item_id):
            ...
            try:
                ...
                webinterface.add_alert(f"Error removing roles permissions: {e}")
        ...
        def page_roles_remove_item_permission_action_get(webinterface, request, session, role_id, platform,
            ...
            print(f"page_roles_remove_item_permission_action_get: action: {action}")
            try:
