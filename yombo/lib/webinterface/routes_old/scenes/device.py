...
def route_scenes_device(webapp):
    with webapp.subroute("/scenes") as webapp:
        ...
        def page_scenes_action_device_add_get(webinterface, request, session, scene_id):
            ...
            webinterface.add_breadcrumb(request, f"/scenes/{scene_id}/add_device", "Add action: Device")
        ...
        def page_scenes_action_device_add_post(webinterface, request, session, scene_id):
            ...
            try:
                ...
                return webinterface.redirect(request, f"/scenes/{scene_id}/add_device")
            ...
            try:
                ...
                webinterface.add_alert(f"Cannot add device to scene. {e.message}", "warning")
                return page_scenes_form_device(webinterface, request, session, scene, data, "add",
                                               "Add device to scene")
        ...
        def page_scenes_action_device_edit_get(webinterface, request, session, scene_id, action_id):
            ...
            webinterface.add_breadcrumb(request, f"/scenes/{scene.scene_id}/edit_device", "Edit action: Device")
        ...
        def page_scenes_action_device_edit_post(webinterface, request, session, scene_id, action_id):
            ...
            try:
                ...
                webinterface.add_alert(f"Cannot edit device within scene. {e.message}", "warning")
                return page_scenes_form_device(webinterface, request, session, scene, data, "add",
                                               "Add device to scene")
        ...
        def page_scenes_action_device_delete_get(webinterface, request, session, scene_id, action_id):
            ...
            root_breadcrumb(webinterface, request)
            webinterface.add_breadcrumb(request, f"/scenes/{scene_id}/details", scene.label)
            webinterface.add_breadcrumb(request, f"/scenes/{scene_id}/delete_device", "Delete action: Device")
            return page.render(alerts=webinterface.get_alerts(),
                               scene=scene,
                               action=action,
                               action_id=action_id,
        ...
        def page_scenes_action_device_delete_post(webinterface, request, session, scene_id, action_id):
            ...
            try:
                ...
                return webinterface.redirect(request,
                                             f"/scenes/{scene_id}/delete_device/{action_id}")
            ...
            try:
                ...
                webinterface.add_alert(f"Cannot delete device from scene. {e.message}", "warning")
                return webinterface.redirect(request, "/scenes/index")
