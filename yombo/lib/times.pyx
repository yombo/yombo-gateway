...
class Times(YomboLibrary, object):
    ...
    def _setup_light_dark_events(self):
        ...
        reactor.callLater(setTime+self.time_ajust, self._setup_light_dark_events)
