...
.. note::
  ...
  `Atoms @ Module Development <https://docs.yombo.net/Libraries/Automation>`_
...
:view-source: `View Source Code <https://docs.yombo.net/gateway/html/current/_modules/yombo/lib/automation.html>`_
"""
