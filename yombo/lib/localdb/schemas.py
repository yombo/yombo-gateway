...
class GatewaysSchema(YomboSchemaBase):
    ...
    internal_port = fields.Integer(allow_none=True)
    external_port = fields.Integer(allow_none=True)
    internal_secure_port = fields.Integer(allow_none=True)
    external_secure_port = fields.Integer(allow_none=True)
