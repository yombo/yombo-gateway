...
:view-source: `View Source Code <https://yombo.net/docs/gateway/html/current/_modules/yombo/lib/devicetypes/platforms/sensor.html>`_
"""
from yombo.constants.features import (FEATURE_NUMBER_OF_STEPS, FEATURE_ALL_ON, FEATURE_ALL_OFF, FEATURE_PINGABLE,
                                      FEATURE_POLLABLE, FEATURE_ALLOW_IN_SCENES, FEATURE_SCENE_CONTROLLABLE,
...
class Sensor(Device):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.FEATURES.update({
            ...
            FEATURE_SCENE_CONTROLLABLE: False,
...
class NoiseSensor(BinarySensor):
    """
