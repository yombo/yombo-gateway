...
:view-source: `View Source Code <https://yombo.net/docs/gateway/html/current/_modules/yombo/lib/devicetypes/platforms/fan.html>`_
"""
...
class Fan(Device):
    ...
    def fan_speed_to_int(self, speed):
        ...
        if isinstance(speed, int):
            if speed >= 0 and speed <= 3:
                return speed
            raise YomboWarning("ui::alerts::devices::invalid_fan_speed")
    ...
    def set_direction(self, direction, **kwargs):
        ...
        if self.check_set_direction(direction) is False:
            raise YomboWarning("ui::alerts::devices::invalid_fan_direction")
