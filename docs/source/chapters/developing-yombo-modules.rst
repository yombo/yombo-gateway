...
`Yombo.Net - Module Development <https://docs.yombo.net/Developing_modules>`_, including
a complete example on
`building your first module <https://docs.yombo.net/Developing_modules/Building_your_first_module>_`.
